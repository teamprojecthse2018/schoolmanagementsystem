...
{
    public partial class frmBookentryRecords1 : Form
    {
        ...
        private void AutocompleteBookReference()
        {
            ...
            try
            {
                ...
                adp.SelectCommand = new SqlCommand("SELECT distinct BookTitle FROM Book where BookTitle is not null", CN);
                ds = new DataSet("ds");
        ...
        private void AutocompleteBooktitle()
        {
            ...
            try
            {
                ...
                CN.Open();
                adp = new SqlDataAdapter();
                adp.SelectCommand = new SqlCommand("SELECT distinct Reference FROM Book where Reference is not null", CN);
                ds = new DataSet("ds");
        ...
        private void AutocompleteDepartment()
        {
            ...
            try
            {
                ...
                CN.Open();
                adp = new SqlDataAdapter();
                adp.SelectCommand = new SqlCommand("SELECT distinct Department FROM Book where Department is not null", CN);
                ds = new DataSet("ds");
        ...
        private void AutocompleteAccessionNo()
        {
            ...
            try
            {
                ...
                CN.Open();
                adp = new SqlDataAdapter();
                adp.SelectCommand = new SqlCommand("SELECT distinct AccessionNo FROM Book where AccessionNo is not null", CN);
                ds = new DataSet("ds");

                adp.Fill(ds);
                dtable = ds.Tables[0];
                cmbAccessionNo.Items.Clear();
        ...
        private void AutocompleteSubject()
        {
            ...
            try
            {
                ...
                CN.Open();
                adp = new SqlDataAdapter();
                adp.SelectCommand = new SqlCommand("SELECT distinct Subject FROM Book where Subject is not null", CN);
                ds = new DataSet("ds");
        ...
        private void AutocompleteAuthor()
        {
            ...
            try
            {
                ...
                CN.Open();
                adp = new SqlDataAdapter();
                adp.SelectCommand = new SqlCommand("SELECT distinct Author FROM Book where Author is not null", CN);
                ds = new DataSet("ds");
        ...
        private void frmBookentryRecords1_Load(object sender, EventArgs e)
        {
        ...
        private void cmbAuthor_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                con.Open();
                cmd = new SqlCommand("SELECT RTRIM(AccessionNo) as [Accession No],RTRIM(BookTitle) as [Book Title],RTRIM(Author) as [Author],RTRIM(Department) as [Department],RTRIM (Barcode) as [Barcode],RTRIM (ISBN) as [ISBN],RTRIM(Volume)as[Volume],RTRIM(Edition) as[Edition],RTRIM(Publisher) as [Publisher],RTRIM(PlaceOfPublisher) as [Place Of Publisher],RTRIM(CD) as[CD],RTRIM(PublishingYear) as [Publishing Year],RTRIM(Reference) as [Refrence],RTRIM(AlmiraPosition) as [Almira Position],RTRIM(Price) as [price],convert(Datetime,BillDate,103) as [Bill Date],SupplierName,Remarks from book  where Author='" + cmbAuthor.Text + "' order by Author", con);
                SqlDataAdapter myDA = new SqlDataAdapter(cmd);
                DataSet myDataSet = new DataSet();
                myDA.Fill(myDataSet, "Book");
        ...
        private void txtAuthor_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                con.Open();
                cmd = new SqlCommand("SELECT RTRIM(AccessionNo) as [Accession No],RTRIM(BookTitle) as [Book Title],RTRIM(Author) ,RTRIM(Department) as [Department],RTRIM (Barcode) as [Barcode],RTRIM (ISBN) as [ISBN],RTRIM(Volume)as[Volume],RTRIM(Edition) as[Edition],RTRIM(Publisher) as [Publisher],RTRIM(PlaceOfPublisher) as [Place Of Publisher],RTRIM(CD) as[CD],RTRIM(PublishingYear) as [Publishing Year],RTRIM(Reference) as [Refrence],RTRIM(AlmiraPosition) as [Almira Position],RTRIM(Price) as [price],convert(Datetime,BillDate,103) as [Bill Date],rtrim(SupplierName) [Supplier Name],rtrim(Remarks) [Remarks] from book  where Author Like '" + txtAuthor.Text + "%' order by BookTitle", con);
                SqlDataAdapter myDA = new SqlDataAdapter(cmd);
                DataSet myDataSet = new DataSet();
                myDA.Fill(myDataSet, "Book");
                dataGridView2.DataSource = myDataSet.Tables["Book"].DefaultView;
        ...
        private void txtJointAuthors_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                con.Open();
                cmd = new SqlCommand("SELECT RTRIM(AccessionNo) as [Accession No],RTRIM(BookTitle) as [Book Title],RTRIM(Author) as [Author], RTRIM(JointAuthors) as [Joint Authors],RTRIM(Subject) as [Subject],RTRIM(Department) as [Department],RTRIM (Barcode) as [Barcode],RTRIM (ISBN) as [ISBN],RTRIM(Volume)as[Volume],RTRIM(Edition) as[Edition],RTRIM(Publisher) as [Publisher],RTRIM(PlaceOfPublisher) as [Place Of Publisher],RTRIM(CD) as[CD],RTRIM(PublishingYear) as [Publishing Year],RTRIM(Reference) as [Refrence],RTRIM(AlmiraPosition) as [Almira Position],RTRIM(Price) as [price],convert(Datetime,BillDate,103) as [Bill Date],rtrim(SupplierName) [Supplier Name],rtrim(Remarks) [Remarks] from book  where jointAuthors Like '" + txtJointAuthors.Text + "%' order by jointAuthors", con);
                SqlDataAdapter myDA = new SqlDataAdapter(cmd);
                DataSet myDataSet = new DataSet();
                myDA.Fill(myDataSet, "Book");
                dataGridView2.DataSource = myDataSet.Tables["Book"].DefaultView;
        ...
        private void cmbAccessionNo_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                con.Open();
                cmd = new SqlCommand("SELECT RTRIM(AccessionNo) as [Accession No],RTRIM(BookTitle) as [Book Title],RTRIM(Author) as [Author], RTRIM(JointAuthors) as [Joint Authors],RTRIM(Subject) as [Subject],RTRIM(Department) as [Department],RTRIM (Barcode) as [Barcode],RTRIM (ISBN) as [ISBN],RTRIM(Volume)as[Volume],RTRIM(Edition) as[Edition],RTRIM(Publisher) as [Publisher],RTRIM(PlaceOfPublisher) as [Place Of Publisher],RTRIM(CD) as[CD],RTRIM(PublishingYear) as [Publishing Year],RTRIM(Reference) as [Refrence],RTRIM(AlmiraPosition) as [Almira Position],RTRIM(Price) as [price],convert(Datetime,BillDate,103) as [Bill Date],rtrim(SupplierName) [Supplier Name],rtrim(Remarks) [Remarks] from book  where AccessionNo='" + cmbAccessionNo.Text + "' order by BookTitle", con);
                SqlDataAdapter myDA = new SqlDataAdapter(cmd);
                DataSet myDataSet = new DataSet();
                myDA.Fill(myDataSet, "Book");
        ...
        private void cmbSubject_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                con.Open();
                cmd = new SqlCommand("SELECT RTRIM(AccessionNo) as [Accession No],RTRIM(BookTitle) as [Book Title],RTRIM(Author) as [Author], RTRIM(JointAuthors) as [Joint Authors],RTRIM(Subject) as [Subject],RTRIM(Department) as [Department],RTRIM (Barcode) as [Barcode],RTRIM (ISBN) as [ISBN],RTRIM(Volume)as[Volume],RTRIM(Edition) as[Edition],RTRIM(Publisher) as [Publisher],RTRIM(PlaceOfPublisher) as [Place Of Publisher],RTRIM(CD) as[CD],RTRIM(PublishingYear) as [Publishing Year],RTRIM(Reference) as [Refrence],RTRIM(AlmiraPosition) as [Almira Position],RTRIM(Price) as [price],convert(Datetime,BillDate,103) as [Bill Date],rtrim(SupplierName) [Supplier Name],rtrim(Remarks) [Remarks] from book  where Subject='" + cmbSubject.Text + "' order by BookTitle", con);
                SqlDataAdapter myDA = new SqlDataAdapter(cmd);
                DataSet myDataSet = new DataSet();
                myDA.Fill(myDataSet, "Book");
        ...
        private void txtSubject_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                con.Open();
                cmd = new SqlCommand("SELECT RTRIM(AccessionNo) as [Accession No],RTRIM(BookTitle) as [Book Title],RTRIM(Author) as [Author], RTRIM(JointAuthors) as [Joint Authors],RTRIM(Subject) as [Subject],RTRIM(Department) as [Department],RTRIM (Barcode) as [Barcode],RTRIM (ISBN) as [ISBN],RTRIM(Volume)as[Volume],RTRIM(Edition) as[Edition],RTRIM(Publisher) as [Publisher],RTRIM(PlaceOfPublisher) as [Place Of Publisher],RTRIM(CD) as[CD],RTRIM(PublishingYear) as [Publishing Year],RTRIM(Reference) as [Refrence],RTRIM(AlmiraPosition) as [Almira Position],RTRIM(Price) as [price],convert(Datetime,BillDate,103) as [Bill Date],rtrim(SupplierName) [Supplier Name],rtrim(Remarks) [Remarks] from book  where Subject Like '" + txtSubject.Text + "%' order by jointAuthors", con);
                SqlDataAdapter myDA = new SqlDataAdapter(cmd);
                DataSet myDataSet = new DataSet();
                myDA.Fill(myDataSet, "Book");
                dataGridView4.DataSource = myDataSet.Tables["Book"].DefaultView;
        ...
        private void cmbDepartment_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                con.Open();
                cmd = new SqlCommand("SELECT RTRIM(AccessionNo) as [Accession No],RTRIM(BookTitle) as [Book Title],RTRIM(Author) as [Author], RTRIM(JointAuthors) as [Joint Authors],RTRIM(Subject) as [Subject],RTRIM(Department) as [Department],RTRIM (Barcode) as [Barcode],RTRIM (ISBN) as [ISBN],RTRIM(Volume)as[Volume],RTRIM(Edition) as[Edition],RTRIM(Publisher) as [Publisher],RTRIM(PlaceOfPublisher) as [Place Of Publisher],RTRIM(CD) as[CD],RTRIM(PublishingYear) as [Publishing Year],RTRIM(Reference) as [Refrence],RTRIM(AlmiraPosition) as [Almira Position],RTRIM(Price) as [price],convert(Datetime,BillDate,103) as [Bill Date],rtrim(SupplierName) [Supplier Name],rtrim(Remarks) [Remarks] from book  where Department='" + cmbDepartment.Text + "' order by Department", con);
                idView6.DataSource = myDataSet.Tables["Book"].DefaultView;
                con.Close();
            }
            catch (Exception ex)
            {
        ...
        private void txtDepartment_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                con.Open();
                cmd = new SqlCommand("SELECT RTRIM(AccessionNo) as [Accession No],RTRIM(BookTitle) as [Book Title],RTRIM(Author) as [Author], RTRIM(JointAuthors) as [Joint Authors],RTRIM(Subject) as [Subject],RTRIM(Department) as [Department],RTRIM (Barcode) as [Barcode],RTRIM (ISBN) as [ISBN],RTRIM(Volume)as[Volume],RTRIM(Edition) as[Edition],RTRIM(Publisher) as [Publisher],RTRIM(PlaceOfPublisher) as [Place Of Publisher],RTRIM(CD) as[CD],RTRIM(PublishingYear) as [Publishing Year],RTRIM(Reference) as [Refrence],RTRIM(AlmiraPosition) as [Almira Position],RTRIM(Price) as [price],convert(Datetime,BillDate,103) as [Bill Date],rtrim(SupplierName) [Supplier Name],rtrim(Remarks) [Remarks] from book  where Department Like '" + txtDepartment.Text + "%' order by Department", con);
                SqlDataAdapter myDA = new SqlDataAdapter(cmd);
                DataSet myDataSet = new DataSet();
                myDA.Fill(myDataSet, "Book");
        ...
        private void cmbRfBook_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                con.Open();
                cmd = new SqlCommand("SELECT RTRIM(AccessionNo) as [Accession No],RTRIM(BookTitle) as [Book Title],RTRIM(Author) as [Author], RTRIM(JointAuthors) as [Joint Authors],RTRIM(Subject) as [Subject],RTRIM(Department) as [Department],RTRIM (Barcode) as [Barcode],RTRIM (ISBN) as [ISBN],RTRIM(Volume)as[Volume],RTRIM(Edition) as[Edition],RTRIM(Publisher) as [Publisher],RTRIM(PlaceOfPublisher) as [Place Of Publisher],RTRIM(CD) as[CD],RTRIM(PublishingYear) as [Publishing Year],RTRIM(Reference) as [Refrence],RTRIM(AlmiraPosition) as [Almira Position],RTRIM(Price) as [price],convert(Datetime,BillDate,103) as [Bill Date],rtrim(SupplierName) [Supplier Name],rtrim(Remarks) [Remarks] from book  where Reference='" + cmbRfBook.Text + "' order by Reference", con);
                SqlDataAdapter myDA = new SqlDataAdapter(cmd);
                DataSet myDataSet = new DataSet();
                myDA.Fill(myDataSet, "Book");
        ...
        private void txtRFBooks_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                con.Open();
                cmd = new SqlCommand("SELECT RTRIM(AccessionNo) as [Accession No],RTRIM(BookTitle) as [Book Title],RTRIM(Author) as [Author], RTRIM(JointAuthors) as [Joint Authors],RTRIM(Subject) as [Subject],RTRIM(Department) as [Department],RTRIM (Barcode) as [Barcode],RTRIM (ISBN) as [ISBN],RTRIM(Volume)as[Volume],RTRIM(Edition) as[Edition],RTRIM(Publisher) as [Publisher],RTRIM(PlaceOfPublisher) as [Place Of Publisher],RTRIM(CD) as[CD],RTRIM(PublishingYear) as [Publishing Year],RTRIM(Reference) as [Refrence],RTRIM(AlmiraPosition) as [Almira Position],RTRIM(Price) as [price],convert(Datetime,BillDate,103) as [Bill Date],rtrim(SupplierName) [Supplier Name],rtrim(Remarks) [Remarks] from book  where Reference Like '" + txtRFBooks.Text + "%' order by Reference", con);
                SqlDataAdapter myDA = new SqlDataAdapter(cmd);
                DataSet myDataSet = new DataSet();
                myDA.Fill(myDataSet, "Book");
                DataGridView7.DataSource = myDataSet.Tables["Book"].DefaultView;
        ...
        private void Button16_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                con.Open();
                cmd = new SqlCommand("SELECT RTRIM(AccessionNo) as [Accession No],RTRIM(BookTitle) as [Book Title],RTRIM(Author) as [Author], RTRIM(JointAuthors) as [Joint Authors],RTRIM(Subject) as [Subject],RTRIM(Department) as [Department],RTRIM (Barcode) as [Barcode],RTRIM (ISBN) as [ISBN],RTRIM(Volume)as[Volume],RTRIM(Edition) as[Edition],RTRIM(Publisher) as [Publisher],RTRIM(PlaceOfPublisher) as [Place Of Publisher],RTRIM(CD) as[CD],RTRIM(PublishingYear) as [Publishing Year],RTRIM(Reference) as [Refrence],RTRIM(AlmiraPosition) as [Almira Position],RTRIM(Price) as [price],convert(Datetime,BillDate,103) as [Bill Date],rtrim(SupplierName) [Supplier Name],rtrim(Remarks) [Remarks] from book order By BookTitle", con);
                SqlDataAdapter myDA = new SqlDataAdapter(cmd);
                DataSet myDataSet = new DataSet();
                myDA.Fill(myDataSet, "Book");
        ...
        private void frmBookentryRecords1_FormClosing(object sender, FormClosingEventArgs e)
        {
            this.Hide();
        ...
        private void frmBookentryRecords1_GiveFeedback(object sender, GiveFeedbackEventArgs e)
        {
