...
{
    public partial class frmBookReturnRecord_Staff_ : Form
    {
        ...
        public frmBookReturnRecord_Staff_()
        {
            InitializeComponent();
        }
        ...
        private void frmBookReturnRecord_Staff__Load(object sender, EventArgs e)
        {
            AutocompleteStaff();
            AutocompleteStaffID();
        }
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                con.Open();
                cmd = new SqlCommand("SELECT rtrim(ReturnID) as [Return ID],(ReturnDate) as [Return Date],rtrim(Fine) [Fine],rtrim(BookIssueStaff.TransactionID) as [Transaction ID],(IssueDate) as [Issue Date],(DueDate) as [Due Date],rtrim(Book.AccessionNo) as [Accession No],rtrim (BookTitle) as [Book Title],rtrim(Author) [Author],rtrim(Subject) [Subject],rtrim(ISBN) [ISBN],rtrim(Edition) as [Edition],rtrim(Employee.StaffID) as [Staff ID],rtrim(StaffName) as [Staff Name],rtrim(Employee.Department) [Department] from Book,BookIssueStaff,Employee,BookReturnStaff where Book.AccessionNo=BookIssueStaff.AccessionNo and BookIssueStaff.StaffID=Employee.StaffID  and BookIssueStaff.TransactionID=BookReturnStaff.TransactionID and ReturnDate Between @date1 and @date2 order by IssueDate", con);
        ...
        private void dataGridView1_RowHeaderMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            try
            {
                ...
                frm.Show();
                frm.txtReturnID1.Text = dr.Cells[0].Value.ToString();
                frm.dtpReturnDate1.Text = dr.Cells[1].Value.ToString();
                frm.txtFine1.Text = dr.Cells[2].Value.ToString();
                frm.txtTransactionID1.Text = dr.Cells[3].Value.ToString();
                frm.dtpIssueDate1.Text = dr.Cells[4].Value.ToString();

                frm.dtpDueDate1.Text = dr.Cells[5].Value.ToString();
         
       
                frm.txtAccessionNo1.Text = dr.Cells[6].Value.ToString();
                frm.txtBookTitle1.Text = dr.Cells[7].Value.ToString();
                frm.txtAuthor1.Text = dr.Cells[8].Value.ToString();
                frm.txtsubject1.Text = dr.Cells[9].Value.ToString();
                frm.txtISBN1.Text = dr.Cells[10].Value.ToString();

                frm.txtEdition1.Text = dr.Cells[11].Value.ToString();
                frm.txtStaffName.Text= dr.Cells[13].Value.ToString();
                frm.txtStaffID.Text = dr.Cells[12].Value.ToString();
                frm.txtDepartment1.Text = dr.Cells[14].Value.ToString();
        ...
        private void frmBookReturnRecord_Staff__FormClosing(object sender, FormClosingEventArgs e)
        {
            this.Hide();
            frmBookReturn frm = new frmBookReturn();
            frm.TabControl1.SelectedTab = frm.TabPage2;
