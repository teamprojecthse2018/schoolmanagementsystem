    ...
    public partial class frmBookEntry : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
                ...
                try
                {
                    ...
                    cmd = new SqlCommand(ct);
                    cmd.Connection = con;
                    cmd.Parameters.Add(new SqlParameter("@find", System.Data.SqlDbType.NChar, 30, "AccessionNo"));
                    cmd.Parameters["@find"].Value =txtAccessionNo.Text;
                    rdr = cmd.ExecuteReader();
                ...
                cmd.Parameters.AddWithValue("@d2" ,txtBookTitle.Text);
                 ...
                 cmd.Parameters.AddWithValue("@d14", txtPublishingYear.Text);
  
                 cmd.Parameters.AddWithValue("@d16", txtAlmiraPosition.Text);
                 cmd.Parameters.AddWithValue("@d17", txtPrice.Text);
                 cmd.Parameters.AddWithValue("@d18",cmbSupplierName.Text);
                 cmd.Parameters.AddWithValue("@d19",dtpBillDate.Text);
                 cmd.Parameters.AddWithValue("@d20",txtRemarks.Text);
                 cmd.Parameters.AddWithValue("@d21",cmbCD.Text);
                 cmd.Parameters.AddWithValue("@d22",cmbReference.Text);
        ...
        private void delete_records()
        {
            ...
            try
            {
                ...
                cmd.Connection = con;
                cmd.Parameters.Add(new SqlParameter("@find", System.Data.SqlDbType.NChar, 15, "AccessionNo"));
           ...
           try
            {
              ...
              con = new SqlConnection(cs.DBcon);
                con.Open();
                string cb = "Update Book Set AccessionNo=@d1, BookTitle=@d2,Author=@d3,JointAuthors=@d4,Subject=@d5,Department=@d6,Barcode=@d7,ISBN=@d8,Volume=@d9,Edition=@d10,Publisher=@d11,PlaceOfPublisher=@d12,PublishingYear=@d13,AlmiraPosition=@d14,Price=@d15,SupplierName=@d16,BillDate=@d17,Remarks=@d18,CD=@d19,Reference=@d20 where AccessionNo='"+TextBox1.Text+"'";
                cmd = new SqlCommand(cb);
                cmd.Connection = con;
                cmd.Parameters.AddWithValue("@d1",txtAccessionNo.Text);
                cmd.Parameters.AddWithValue("@d2",txtBookTitle.Text);
                ...
                cmd.Parameters.AddWithValue("@d12",txtPlaceOfPublisher.Text);
                 ...
                 cmd.Parameters.AddWithValue("@d14", txtAlmiraPosition.Text);
                cmd.Parameters.AddWithValue("@d15",txtPrice.Text);
                cmd.Parameters.AddWithValue("@d16",cmbSupplierName.Text);
                cmd.Parameters.AddWithValue("@d17",dtpBillDate.Text);
                cmd.Parameters.AddWithValue("@d18",txtRemarks.Text);
                cmd.Parameters.AddWithValue("@d19",cmbCD.Text);
                cmd.Parameters.AddWithValue("@d20",cmbReference.Text);
                con = new SqlConnection(cs.DBcon);
                con.Open();
