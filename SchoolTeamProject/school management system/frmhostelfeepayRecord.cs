    ...
    public partial class frmhostelfeepayRecord : Form
    {
        ...
        private void AutocompleteClass()
        {
            ...
            try
            {
                ...
                CN.Open();
                adp = new SqlDataAdapter();
                adp.SelectCommand = new SqlCommand("SELECT distinct RTRIM(student.class) FROM HostelFeePayment,Student,Hosteler where HostelFeePayment.AdmissionNo=Student.AdmissionNo and Hosteler.AdmissionNo=Student.AdmissionNo", CN);
                ds = new DataSet("ds");
