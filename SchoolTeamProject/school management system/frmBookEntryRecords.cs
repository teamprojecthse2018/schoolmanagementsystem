         ...
         private void AutocompleteBookReference()
        {
         ...
         private void AutocompleteSubject()
         {
             ...
             try
             {
                 ...
                 CN.Open();
                 adp = new SqlDataAdapter();
                 adp.SelectCommand = new SqlCommand("SELECT distinct Subject FROM Book", CN);
                 ds = new DataSet("ds");
